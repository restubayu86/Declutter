...
const GUIDE = {
  kamar_mandi: {
    ...
    icon: '🚿',
    items: [
      { no:1,  name:'Botol sampo kosong',            action:'Sudah habis' },
      { no:2,  name:'Botol sabun kosong',            action:'Menumpuk' },
      { no:3,  name:'Produk expired',                action:'Kadaluarsa' },
      { no:4,  name:'Sikat gigi lama',               action:'>3 bulan' },
      { no:5,  name:'Pasta gigi kosong',             action:'Tidak terpakai' },
      { no:6,  name:'Ember retak',                   action:'Bocor' },
      { no:7,  name:'Gayung pecah',                  action:'Tidak nyaman' },
      { no:8,  name:'Rak berkarat',                  action:'Sulit dibersihkan' },
      { no:9,  name:'Handuk kasar',                  action:'Bau/kusam' },
      { no:10, name:'Keset kotor',                   action:'Tidak layak' },
      { no:11, name:'Produk hotel',                  action:'Tidak dipakai' },
      { no:12, name:'Sample skincare',               action:'Menumpuk' },
      { no:13, name:'Sisir patah',                   action:'Rusak' },
      { no:14, name:'Sabun banyak jenis',            action:'Duplikat' },
      { no:15, name:'Sampo tidak cocok',             action:'Tidak dipakai' },
      { no:16, name:'Alat cukur lama',               action:'Tumpul' },
      { no:17, name:'Kapas lama',                    action:'Kotor' },
      { no:18, name:'Tempat sabun rusak',            action:'Berjamur' },
      { no:19, name:'Botol spray kosong',            action:'Tidak dipakai' },
      { no:20, name:'Obat lama',                     action:'Kadaluarsa' },
      { no:21, name:'Parfum kosong',                 action:'Tidak dipakai' },
      { no:22, name:'Tempat sikat gigi jamuran',     action:'Sulit dibersihkan' },
      { no:23, name:'Selang air bocor',              action:'Tidak berfungsi' },
      { no:24, name:'Botol lotion kosong',           action:'Kotor' },
      { no:25, name:'Pembersih WC kosong',           action:'Tidak dipakai' },
    ]
  },
  ...
  dapur: {
    ...
    items: [
      ...
      { no:3,  name:'Sendok bengkok',                action:'Rusak' },
      { no:4,  name:'Garpu tidak lengkap',           action:'Duplikat' },
      { no:5,  name:'Wajan lengket',                 action:'Rusak' },
      { no:6,  name:'Pisau tumpul',                  action:'Tidak dipakai' },
      { no:7,  name:'Talenan jamuran',               action:'Sulit dibersihkan' },
      { no:8,  name:'Tupperware tanpa tutup',        action:'Tidak lengkap' },
      { no:9,  name:'Tutup tanpa wadah',             action:'Tidak terpakai' },
      { no:10, name:'Botol plastik bekas',           action:'Menumpuk' },
      { no:11, name:'Bumbu expired',                 action:'Kadaluarsa' },
      { no:12, name:'Saus lama',                     action:'Kadaluarsa' },
      { no:13, name:'Plastik belanja',               action:'Berlebihan' },
      { no:14, name:'Sedotan banyak',                action:'Jarang dipakai' },
      { no:15, name:'Gelas souvenir',                action:'Duplikat' },
      { no:16, name:'Rice cooker rusak',             action:'Tidak dipakai' },
      { no:17, name:'Spons lama',                    action:'Bau' },
      { no:18, name:'Lap dapur kusam',               action:'Kotor' },
      { no:19, name:'Alat dapur unik',               action:'Jarang dipakai' },
      { no:20, name:'Kardus makanan',                action:'Menumpuk' },
      { no:21, name:'Botol kecap kosong',            action:'Habis' },
      { no:22, name:'Toples tanpa tutup',            action:'Tidak lengkap' },
      { no:23, name:'Ember bocor',                   action:'Tidak layak' },
      { no:24, name:'Handuk dapur kusam',            action:'Terlalu lusuh' },
      { no:25, name:'Alat dapur duplikat',           action:'Terlalu banyak' },
    ]
  },
  ...
  laundry: {
    ...
    icon: '🧺',
    items: [
      { no:1,  name:'Hanger bengkok',                action:'Rusak' },
      { no:2,  name:'Ember bocor',                   action:'Tidak layak' },
      { no:3,  name:'Deterjen lama',                 action:'Menggumpal' },
      { no:4,  name:'Pewangi kosong',                action:'Tidak dipakai' },
      { no:5,  name:'Botol bekas',                   action:'Menumpuk' },
      { no:6,  name:'Kain lap banyak',               action:'Berlebihan' },
      { no:7,  name:'Jemuran rusak',                 action:'Tidak stabil' },
      { no:8,  name:'Jepitan patah',                 action:'Tidak kuat' },
      { no:9,  name:'Sikat baju rusak',              action:'Bulu habis' },
      { no:10, name:'Keranjang pecah',               action:'Rusak' },
      { no:11, name:'Kabel mesin cuci rusak',        action:'Bahaya' },
      { no:12, name:'Selang bocor',                  action:'Tidak efisien' },
      { no:13, name:'Deterjen banyak merek',         action:'Duplikat' },
      { no:14, name:'Plastik laundry',               action:'Menumpuk' },
      { no:15, name:'Kaos kaki hilang pasangan',     action:'Tidak lengkap' },
      { no:16, name:'Handuk lap lama',               action:'Kusam' },
      { no:17, name:'Karung bekas',                  action:'Tidak dipakai' },
      { no:18, name:'Pengharum lama',                action:'Tidak dipakai' },
      { no:19, name:'Rak plastik retak',             action:'Rusak' },
      { no:20, name:'Kardus deterjen',               action:'Menumpuk' },
      { no:21, name:'Botol pewangi kosong',          action:'Tidak dipakai' },
      { no:22, name:'Setrika rusak',                 action:'Tidak berfungsi' },
      { no:23, name:'Kabel setrika terkelupas',      action:'Bahaya' },
      { no:24, name:'Papan gosok lama',              action:'Tidak berguna' },
      { no:25, name:'Lap mesin cuci bau',            action:'Tidak higienis' },
    ]
  },
  ...
  lemari_pakaian: {
    ...
    icon: '👔',
    items: [
      { no:1,  name:'Baju kekecilan',                action:'Tidak muat' },
      { no:2,  name:'Baju kebesaran',                action:'Tidak dipakai' },
      { no:3,  name:'Kaos kusam',                    action:'Pudar' },
      { no:4,  name:'Celana sobek',                  action:'Rusak' },
      { no:5,  name:'Jaket jarang dipakai',          action:'>1 tahun' },
      { no:6,  name:'Celana dalam longgar',          action:'Tidak nyaman' },
      { no:7,  name:'Kaos kaki bolong',              action:'Rusak' },
      { no:8,  name:'Baju promosi',                  action:'Tidak dipakai' },
      { no:9,  name:'Seragam lama',                  action:'Tidak dipakai' },
      { no:10, name:'Tas rusak',                     action:'Sobek' },
      { no:11, name:'Dompet lama',                   action:'Rusak' },
      { no:12, name:'Ikat pinggang retak',           action:'Pecah' },
      { no:13, name:'Sepatu rusak',                  action:'Sol lepas' },
      { no:14, name:'Sandal lama',                   action:'Tidak nyaman' },
      { no:15, name:'Topi jarang dipakai',           action:'Menumpuk' },
      { no:16, name:'Gantungan rusak',               action:'Tidak layak' },
      { no:17, name:'Baju sentimental',              action:'Tidak dipakai' },
      { no:18, name:'Aksesoris rusak',               action:'Tidak lengkap' },
      { no:19, name:'Jam mati',                      action:'Tidak dipakai' },
      { no:20, name:'Plastik pembungkus',            action:'Menumpuk' },
      { no:21, name:'Kaos tidak disukai',            action:'Tidak nyaman' },
      { no:22, name:'Baju olahraga lama',            action:'Tidak nyaman' },
      { no:23, name:'Sepatu duplikat',               action:'Berlebihan' },
      { no:24, name:'Hanger rusak',                  action:'Tidak layak' },
      { no:25, name:'Kaos promosi acara',            action:'Tidak dipakai' },
    ]
  },
  ...
  kamar_tidur: {
    ...
    icon: '🛏️',
    items: [
      { no:1,  name:'Charger rusak',                 action:'Tidak berfungsi' },
      { no:2,  name:'Kabel tidak jelas',             action:'Tidak dipakai' },
      { no:3,  name:'Kardus kosong',                 action:'Menumpuk' },
      { no:4,  name:'Sprei kusam',                   action:'Rusak' },
      { no:5,  name:'Sarung bantal sobek',           action:'Tidak layak' },
      { no:6,  name:'Bantal terlalu banyak',         action:'Tidak dipakai' },
      { no:7,  name:'Boneka lama',                   action:'Menumpuk' },
      { no:8,  name:'Buku lama',                     action:'Tidak dibaca' },
      { no:9,  name:'Majalah lama',                  action:'Menumpuk' },
      { no:10, name:'Nota lama',                     action:'Tidak penting' },
      { no:11, name:'Botol minum bekas',             action:'Tidak dipakai' },
      { no:12, name:'Plastik random',                action:'Menumpuk' },
      { no:13, name:'Tas kresek',                    action:'Berlebihan' },
      { no:14, name:'Lampu rusak',                   action:'Tidak dipakai' },
      { no:15, name:'Obat lama',                     action:'Kadaluarsa' },
      { no:16, name:'Earphone rusak',                action:'Tidak dipakai' },
      { no:17, name:'Kipas kecil rusak',             action:'Tidak berfungsi' },
      { no:18, name:'Kertas catatan lama',           action:'Tidak penting' },
      { no:19, name:'Pajangan tidak disukai',        action:'Tidak relevan' },
      { no:20, name:'Barang nanti dipakai',          action:'Tidak jelas' },
      { no:21, name:'Remote rusak',                  action:'Tidak berfungsi' },
      { no:22, name:'Kotak aksesoris kosong',        action:'Menumpuk' },
      { no:23, name:'Pulpen mati',                   action:'Tidak dipakai' },
      { no:24, name:'Selimut lama',                  action:'Kusam' },
      { no:25, name:'Rak kecil retak',               action:'Rusak' },
    ]
  },
  ...
  ruang_tamu: {
    ...
    icon: '🛋️',
    items: [
      { no:1,  name:'Dekorasi berlebihan',           action:'Tidak penting' },
      { no:2,  name:'Majalah lama',                  action:'Menumpuk' },
      { no:3,  name:'Remote rusak',                  action:'Tidak dipakai' },
      { no:4,  name:'Kabel semrawut',                action:'Tidak jelas' },
      { no:5,  name:'Vas kosong',                    action:'Tidak digunakan' },
      { no:6,  name:'Pajangan debuan',               action:'Sulit dibersihkan' },
      { no:7,  name:'Sofa rusak',                    action:'Tidak nyaman' },
      { no:8,  name:'Bantal sofa berlebih',          action:'Menumpuk' },
      { no:9,  name:'Kalender lama',                 action:'Tidak relevan' },
      { no:10, name:'Brosur lama',                   action:'Tidak penting' },
      { no:11, name:'Mainan rusak',                  action:'Tidak dipakai' },
      { no:12, name:'Karpet kusam',                  action:'Sulit dibersihkan' },
      { no:13, name:'Kursi rusak',                   action:'Tidak aman' },
      { no:14, name:'Meja kecil tidak dipakai',      action:'Menghalangi' },
      { no:15, name:'CD/DVD lama',                   action:'Tidak dipakai' },
      { no:16, name:'Speaker rusak',                 action:'Tidak dipakai' },
      { no:17, name:'Tanaman mati',                  action:'Tidak terawat' },
      { no:18, name:'Lampu mati',                    action:'Tidak dipakai' },
      { no:19, name:'Kardus paket',                  action:'Menumpuk' },
      { no:20, name:'Hiasan trend lama',             action:'Tidak relevan' },
      { no:21, name:'Taplak kusam',                  action:'Kotor' },
      { no:22, name:'Rak pajangan penuh',            action:'Berlebihan' },
      { no:23, name:'Helm lama',                     action:'Rusak' },
      { no:24, name:'Koran lama',                    action:'Tidak relevan' },
      { no:25, name:'Jam dinding mati',              action:'Tidak dipakai' },
    ]
  },
  ...
  gudang: {
    ...
    icon: '🏚️',
    items: [
      { no:1,  name:'Kardus kosong',                 action:'Menumpuk' },
      { no:2,  name:'Barang rusak',                  action:'Tidak diperbaiki' },
      { no:3,  name:'Kabel random',                  action:'Tidak jelas' },
      { no:4,  name:'Sparepart lama',                action:'Tidak dipakai' },
      { no:5,  name:'Plastik bekas',                 action:'Berlebihan' },
      { no:6,  name:'Cat sisa lama',                 action:'Kering' },
      { no:7,  name:'Paku/skrip acak',               action:'Tidak terorganisir' },
      { no:8,  name:'Mesin rusak',                   action:'Tidak dipakai' },
      { no:9,  name:'Helm lama',                     action:'Rusak' },
      { no:10, name:'Ban bekas',                     action:'Tidak dipakai' },
      { no:11, name:'Botol kimia kosong',            action:'Tidak dipakai' },
      { no:12, name:'Peralatan proyek lama',         action:'Tidak relevan' },
      { no:13, name:'Furniture rusak',               action:'Tidak dipakai' },
      { no:14, name:'Kayu sisa',                     action:'Menumpuk' },
      { no:15, name:'Tas lama',                      action:'Tidak dipakai' },
      { no:16, name:'Koper rusak',                   action:'Tidak layak' },
      { no:17, name:'Elektronik mati',               action:'Tidak diperbaiki' },
      { no:18, name:'Rak patah',                     action:'Tidak aman' },
      { no:19, name:'Alat manual rusak',             action:'Tidak dipakai' },
      { no:20, name:'Barang mystery box',            action:'Tidak diketahui' },
      { no:21, name:'Karung bekas',                  action:'Menumpuk' },
      { no:22, name:'Botol oli kosong',              action:'Tidak berguna' },
      { no:23, name:'Pipa sisa proyek',              action:'Tidak dipakai' },
      { no:24, name:'Kabel charger mati',            action:'Tidak dipakai' },
      { no:25, name:'Peralatan patah',               action:'Rusak' },
    ]
  }
};
